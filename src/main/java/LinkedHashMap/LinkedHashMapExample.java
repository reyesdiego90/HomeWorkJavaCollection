...
public class LinkedHashMapExample {
    static LinkedHashMap<Integer, Animal> animalList = new LinkedHashMap<>();
    public static BufferedReader br = new BufferedReader(new InputStreamReader(System.in));

    public static void addData() throws IOException {
        Animal.resetScreen();
        String nameAnimal, noiseAnimal;
        System.out.println("=============== LinkedHashMap: Add ===============");
    ...
    public static void removeData() throws IOException {
        System.out.println("=============== LinkedHashMap: Remove Data ===============");
        String nameAnimal;
    ...
    public static void updateData() throws IOException {
        System.out.println("=============== LinkedHashMap: Update Data ===============");
    ...
    public static void iterateData() {
        Animal.resetScreen();
        System.out.println("=============== LinkedHashMap: Iterate ===============");
        animalList.forEach((k, v) -> {
            System.out.println("Key is : " + k + "   Value is : " + v);
        });
    }
